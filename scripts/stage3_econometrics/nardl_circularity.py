"""
Stage 3 (Robustness): NARDL Circularity Robustness Checks
Estimates NARDL models on disaggregated series derived under circularity-free specifications.
"""
...
# Load the dataset
file_path = './Interpolated_TiVA_DVA_Circularity.csv'
...
if not final_grid_df.empty:
    ...
    coeff_df.to_csv('nardl_coefficients_circ.txt', sep='\t', index=False)
    print("Saved nardl_coefficients_circ.txt")
...
if 'best_model' in locals():
    ...
    with open('nardl_wald_test_circ.txt', 'w') as f:
    ...
    print("Saved nardl_wald_test_circ.txt")
